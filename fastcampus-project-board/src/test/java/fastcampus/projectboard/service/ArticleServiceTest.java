...
@ExtendWith(MockitoExtension.class) //MockingTest
class ArticleServiceTest {
    ...
    *각 게시글 페이지로 이동
    *페이지네이션
    * 홈 버튼 -> 게시판 페이지로 리다이렉션 MaincontrollerTest참고
    * 정렬 기능
    * */
    ...
    @Test
    void givenModifiedArticleInfo_whenUpdateArticle_thenUpdateArticle() {
        // Given
        Article article = createArticle();
